...
export const gunlukKaliteIyilestirmeleri20260803:Mera[]=[
  ...
  },
  {
    ...
    camping:"Uygun değil",vehicleAccess:"Orta",amenities:["Kamusal sahil yürüyüş hattı","Çengelköy vapur iskelesi yakınında toplu taşıma bağlantısı","Çengelköy Açık Otoparkı planlama referansı","Mahalle içinde market ve yeme içme","Üsküdar merkezinde konaklama seçenekleri"],
    ...
    navigationNote:"Pin Çengelköy merkezdeki genel kamusal sahil yürüyüş bölümünü gösterir. Navigasyonla Çengelköy merkezine gelindikten sonra son yaklaşım yaya yapılmalıdır; vapur iskelesinin yanaşma/yolcu alanı, bağlı tekneler ve Kuleli yönündeki askerî veya kapalı güvenlik sahaları kesinlikle rota değildir.",
    ...
    transport:"Toplu taşımada güncel Şehir Hatları tarifesinden Çengelköy İskelesi'ne gelen seferler veya Üsküdar–Beykoz sahil koridorundaki otobüs/minibüs bağlantıları kullanılabilir. Çengelköy merkezinde indikten sonra son bölüm dar mahalle dokusu ve sahil yürüyüş bandı üzerinden yaya geçilir; iskele operasyon yüzeyine girilmez. Araçla gelişte İSPARK Çengelköy Açık Otoparkı yalnızca planlama referansıdır; yer garantisi vermez. Dar sokaklarda, durak önünde veya yaya hattında park edilmemeli; dönüş öncesi vapur/otobüs saati yeniden kontrol edilmelidir. Gecelik kalış için Üsküdar merkezindeki ruhsatlı seçenekler ayrıca doğrulanmalıdır.",
