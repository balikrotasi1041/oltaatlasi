...
import { applyDailyQuality20260906Stage2Supplement } from "./meralar-daily-quality-2026-09-06-stage2-supplement";
...
export const applyGunlukSonuc20260818=(routeMap:Map<string,EnrichedMera>)=>{
  ...
  applyDailyQuality20260906Stage2Supplement(routeMap);
