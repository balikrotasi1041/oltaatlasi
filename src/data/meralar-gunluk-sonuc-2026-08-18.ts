...
import { applyDailyQualityStage3_20260828 } from "./meralar-daily-quality-2026-08-28-stage3";
import { applyDailyQualityStage4Fixes20260828 } from "./meralar-daily-quality-2026-08-28-stage4-fixes";
...
export const applyGunlukSonuc20260818=(routeMap:Map<string,EnrichedMera>)=>{
  ...
  applyDailyQualityStage3_20260828(routeMap);
  applyDailyQualityStage4Fixes20260828(routeMap);
  return routeMap;
};