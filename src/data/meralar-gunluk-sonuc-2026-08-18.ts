...
import { applyDailyQuality20260902Stage2 } from "./meralar-daily-quality-2026-09-02-stage2";
import { applyDailyQuality20260902Stage2B } from "./meralar-daily-quality-2026-09-02-stage2b";
import { applyDailyQuality20260902Stage2C } from "./meralar-daily-quality-2026-09-02-stage2c";
...
export const applyGunlukSonuc20260818=(routeMap:Map<string,EnrichedMera>)=>{
  ...
  applyDailyQuality20260902Stage2(routeMap);
  applyDailyQuality20260902Stage2B(routeMap);
  applyDailyQuality20260902Stage2C(routeMap);
