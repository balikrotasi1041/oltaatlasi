...
const cigdemBaliklandirma:ResearchSource={label:"Kastamonu İl Tarım ve Orman Müdürlüğü - Çiğdem Göleti balıklandırması",url:"https://kastamonu.tarimorman.gov.tr/Haber/1053/Ilimizde-Goletler-Baliklandirildi",note:"Devrekâni Çiğdem Göleti'ne 20.000 aynalı/pullu sazan yavrusu bırakıldığını rota özelinde doğrular; av garantisi değildir."};
const ataturkBaliklandirma:ResearchSource={label:"Adıyaman İl Tarım ve Orman Müdürlüğü - Atatürk Baraj Gölü 2024 balıklandırması",url:"https://adiyaman.tarimorman.gov.tr/Haber/780/Ataturk-Baraji-Golune-7-Milyon-Balik-Yavrusu-Birakildi",note:"Atatürk Baraj Gölü'ne 2024'te 2,55 milyon şabut ve daha önce 4,5 milyon sazan yavrusu bırakıldığını doğrular."};
const ataturkFauna:ResearchSource={label:"Natural and Engineering Sciences - Atatürk Baraj Gölü balık faunası",url:"https://dergipark.org.tr/tr/pub/nesciences/article/1036854",note:"2013-2015 örneklemesinde Atatürk Baraj Gölünde 25 balık türü tespit eden akademik çalışmadır."};
const karahoyukBaliklandirma:ResearchSource={label:"Adıyaman İl Tarım ve Orman Müdürlüğü - 2024 göl ve gölet balıklandırması",url:"https://adiyaman.tarimorman.gov.tr/Haber/773/Gol-Ve-Goletlerimizdeki-Balik-Populasyonunu-Arttiriyoruz",note:"Karahöyük Göletinin 2024 yılında sazan yavrusu bırakılan Adıyaman su kaynakları arasında olduğunu rota adıyla doğrular."};
const adiyamanFauna:ResearchSource={label:"Aquaculture Studies - Adıyaman Bölgesi Balık Faunası Dağılımı",url:"https://dergipark.org.tr/en/pub/yunusae/article/263528",note:"Adıyaman bölgesinde 3 doğal göl, 2 baraj gölü ve 10 akarsuda 26 takson kaydeden akademik bölgesel çalışmadır; tek başına mikro gölet stok garantisi değildir."};
const kemaliyeKaymakamlik:ResearchSource={label:"Kemaliye Kaymakamlığı - Genel Bilgiler",url:"https://kemaliye.gov.tr/genel-bilgiler-kemaliye",note:"Karasu/Fırat'ın Kemaliye ilçesini ikiye bölerek Keban Baraj Gölüne kavuştuğu genel coğrafi koridoru resmî olarak doğrular."};
const kemaliyeBalik:ResearchSource={label:"Fırat Üniversitesi - Keban Baraj Gölü Kemaliye Bölgesinde Avlanan Balıklar",url:"https://dergipark.org.tr/tr/pub/fufbd/article/400681",note:"Kemaliye bölgesinde sazan dahil 7 ekonomik balık türünü doğrudan av verisiyle kaydeder; belirli kıyıda av garantisi değildir."};
const gumuslerAkademik:ResearchSource={label:"Niğde Yöresi Yapay Gölleri - Gümüşler Barajı ekoloji ve kullanım incelemesi",url:"https://dergipark.org.tr/tr/download/article-file/32280",note:"Gümüşler Barajının konumu, sulama işlevi, çevresinde balık tutma kullanımı ve sazan/aynali sazan/kefal gibi tür kayıtlarını akademik-coğrafi çalışmada birlikte verir."};
...
export const stage2Promotions20260825:Promotion[]=[
  ...
  {slug:"ulusal-kastamonu-cigdem-baraj-golu-kastamonu",addedSources:[cigdemBaliklandirma],reason:"Kastamonu İl Tarım kaydı suyun resmî adını Çiğdem Göleti olarak ve 20.000 aynalı/pullu sazan balıklandırmasını rota özelinde doğrular; mevcut yer/tesis kaynaklarıyla birlikte değerlendirildi.",access:"Devrekâni/Çiğdem çevresi yalnız genel yaklaşım bağlamıdır; son park, kıyı geçişi, kiralama/istihsal sınırı ve özel parseller saha teyitli değildir.",species:"2018 tarihli 20.000 sazan balıklandırması kalıcı tür olasılığı kanıtıdır; güncel stok veya av başarısı garantisi değildir."},
  {slug:"ankara-500km-adiyaman-ataturk-baraj-golu",addedSources:[ataturkBaliklandirma,ataturkFauna],reason:"Adıyaman İl Tarım 2024 balıklandırması ve 2021 akademik doğrudan fauna çalışması Atatürk Baraj Gölünün kimlik ve tür katmanlarını güçlü biçimde çaprazlıyor.",access:"Atatürk Baraj Gölü çok geniştir ve ticari istihsal bölgeleri/kiralı avlaklar vardır; yalnız genel göl planlama kaydı tutulur, tek bir kıyı cebinin kamusal ve sürekli açık olduğu iddia edilmez.",species:"Sazan ve şabut için güncel resmî balıklandırma; toplam 25 tür için doğrudan akademik örnekleme vardır. Bunlar av garantisi değildir."},
  {slug:"ankara-500km-adiyaman-karahuyuk-goleti",addedSources:[karahoyukBaliklandirma,adiyamanFauna],reason:"Adıyaman İl Tarım 2024 kaydı Karahöyük Göletini rota adıyla sazan balıklandırılan su kaynakları arasında sayıyor; Adıyaman bölgesel akademik fauna çalışması havza tür bağlamını bağımsız olarak destekliyor.",access:"Karahöyük çevresi için yalnız genel yerleşim/gölet yaklaşımı kabul edilir; son kıyı girişi, mülkiyet ve olası kiralama sınırı saha teyitli değildir.",species:"Sazan rota özelindeki 2024 resmî balıklandırmayla güçlü olasılıktır; bölgesel akademik fauna yalnız destekleyici bağlamdır ve av garantisi değildir."},
  {slug:"ulusal-erzincan-firat-nehri-kemaliye-hatti",addedSources:[kemaliyeKaymakamlik,kemaliyeBalik],reason:"Kemaliye Kaymakamlığı Karasu/Fırat'ın ilçe içindeki genel koridorunu resmî olarak doğruluyor; Fırat Üniversitesi çalışması Keban Baraj Gölü Kemaliye bölümünde doğrudan avlanan türleri kaydediyor.",access:"Kemaliye-Fırat/Keban koridoru sarp kanyonlar ve değişken kıyı erişimi içerir; turistik tekne/kanyon kullanımı kamusal olta erişimi anlamına gelmez, yalnız genel bölge planlanır.",species:"Kemaliye bölümünde sazan dahil 7 tür doğrudan akademik av verisiyle kayıtlıdır; her mikro kıyıda bulunacağı varsayılmaz."},
  {slug:"ulusal-nigde-gumusler-baraj-golu",addedSources:[gumuslerAkademik],reason:"Gümüşler Barajının su kimliği, sulama işlevi, çevresinde balık tutma kullanımı ve türleri akademik-coğrafi çalışmada birlikte belgeleniyor; mevcut resmî/yerel rota kaynakları ve güncel mevzuatla çaprazlandı.",access:"Gümüşler Barajı çevresindeki genel kullanım kaydı mikro kıyı izni değildir; son park, özel mülkiyet, tesis sınırı ve güncel tabela saha teyitli değildir.",species:"Sazan, aynalı sazan ve kefal gibi türler Gümüşler yapay gölü için kaynakta açıkça kaydedilmiştir; güncel yoğunluk ve av başarısı garantisi değildir."},
];
