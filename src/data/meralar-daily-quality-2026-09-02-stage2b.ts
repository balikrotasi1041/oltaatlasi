...
const yapialtinCurrent:ResearchSource={label:"Yerel 2026 saha kaydı · Yapıaltın Barajı",url:"https://www.sivasekspres.com/haber/sarkislada-olta-ile-yakalanan-dev-sazan-ilgi-odagi-oldu-112445.html",note:"2026 tarihli yerel saha kaydı Yapıaltın Barajı'nda amatör olta kullanımını ve sazan yakalandığını destekleyici kanıt olarak aktarır; kamusal mikro giriş garantisi değildir."};
...
const promotions:Record<(typeof promoted20260902Stage2B)[number],Promotion>={
  ...
  "ulusal-sivas-delice-baraj-golu-sivas":{district:"İmranlı",sources:[deliceCurrent,deliceLocal],fish:[{name:"Sazan",scientificName:"Cyprinus carpio",source:deliceCurrent,note:"2025 Tarım ve Orman içsu balıklandırmasında Delice Göleti'ne yavru sazan bırakıldığı rota adıyla kaydedilmiştir; av garantisi değildir."}],access:"Delice Göleti'nde Kaymakam katılımlı balıklandırma programı ve amatör/sportif balıkçılığı destekleyen yerel kamu aktarımı genel kullanım bağlamı sağlar. Kesin kıyı girişinin kamusal ve güvenli olduğu masa başından doğrulanmış değildir.",summary:"İmranlı Delice Göleti; 2025 Tarım ve Orman balıklandırma kaydı, Kaymakamlık katılımlı saha programı ve amatör balıkçılık bağlamını destekleyen ikinci kaynak ailesiyle Güven C genel planlama düzeyine yükseltilmiştir. Mikro kıyı ve güncel su kotu saha teyitlidir.",caution:"Yüksek rakım, ani hava, düşük su sıcaklığı, çamurlu/dik kıyı ve sulama/işletme hareketleri risk yaratabilir; suya girilmemeli ve son yaklaşım gündüz kontrol edilmelidir."},
};
