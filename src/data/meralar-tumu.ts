...
import { istinyeIyilestirme20260814 } from "./meralar-istanbul-2026-08-14-istinye";
...
for(const [slug,patch] of Object.entries(istanbulKocaeliIyilestirmeleri20260814))if(!["maltepe-sahili","pendik-sahili"].includes(slug))applyPatch(slug,patch);
for(const [slug,patch] of Object.entries(istanbulEkIyilestirme20260814))applyPatch(slug,patch);
for(const [slug,patch] of Object.entries(istinyeIyilestirme20260814))applyPatch(slug,patch);
