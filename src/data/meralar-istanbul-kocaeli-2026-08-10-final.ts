...
import { kutahyaYeni20260812 } from "./meralar-kutahya-2026-08-12";
...
export const istanbulKocaeliYeni20260810Final:Mera[]=[...istanbulKocaeliYeni20260810Evening.map(corrected),...kutahyaYeni20260812];
