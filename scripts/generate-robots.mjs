...
const dailyMatch=dailySource.match(/export const gunlukMeralar: Mera\[\] = (\[.*\]);\s*$/s);
if(!dailyMatch) throw new Error("Günlük mera verisi image sitemap için okunamadı.");
const meralar=[...JSON.parse(baseMatch[1]),...Function(`"use strict"; return (${dailyMatch[1]});`)()];
