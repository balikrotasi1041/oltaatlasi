...
const source=readFileSync("src/data/meralar.ts","utf8");
const match=source.match(/export const meralar: Mera\[\] = (\[.*?\n\]);\n\nexport const provinces/s);
if(!match) throw new Error("Mera verisi image sitemap için okunamadı.");
const meralar=JSON.parse(match[1]);
